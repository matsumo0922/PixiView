package caios.android.fanbox.core.ui.ads.template;
...
public class NativeAdsTemplateStyle {
    ...
    public static class Builder {
        ...
        private NativeAdsTemplateStyle styles;

        public Builder() {
            this.styles = new NativeAdsTemplateStyle();
        }
        ...
        public NativeAdsTemplateStyle build() {
            return styles;
        }
    }
}
